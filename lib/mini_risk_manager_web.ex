defmodule MiniRiskManagerWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      ...
      import Plug.Conn
      import MiniRiskManagerWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/mini_risk_manager_web/templates",
        namespace: MiniRiskManagerWeb
  ...
  defp view_helpers do
    quote do
      ...
      import MiniRiskManagerWeb.ErrorHelpers
      import MiniRiskManagerWeb.Gettext
      alias MiniRiskManagerWeb.Router.Helpers, as: Routes
    end
  end
